        ...
        <div class="flex-1 min-w-0 overflow-hidden">
          <CardTitle class="text-base sm:text-lg truncate">
            <span
              ...
              :data-tooltip="`View details for ${endpoint.name}`"
              role="link"
              tabindex="0"
      ...
      <div class="space-y-2">
        <div>
          <div class="flex items-center justify-between mb-1">
            ...
            <p class="text-xs text-muted-foreground" :data-tooltip="showAverageResponseTime ? 'Average response time' : 'Minimum and maximum response time'">{{ formattedResponseTime }}</p>
          </div>
